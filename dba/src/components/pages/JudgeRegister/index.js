...
class JudgeRegister extends Component {
  render() {
    return (
      <>
        {/* <!-- ======= Welcome ======= --> */}
          ...
          <div className="container wow fadeInUp">
            <div className="row">
              <div className="col-md-12">
                <h1 className="section-title">Judge Registration</h1>
                <div className="section-title-divider"></div>
                <div className="container align-content-center">
                  <div className="col-md-9">
                    <form
                      id="judge-reg contact_form"
        ...
        <a href="/judgeregister" className="back-to-top">
